...
var wobbleRate = 30, wobbleSpan = 0.05;

Powerup.prototype.act = function(step) {
  this.wobble += step * wobbleRate;
  var wobblePos = Math.sin(this.wobble) * wobbleSpan;
  this.pos = this.basePos.plus(new Vector(0, wobblePos));
};
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  if (type == "next" && this.status == null) {
    ...
    this.player.pos = new Vector(22, 1);
  }

  else if(type == "anoportal"){
    this.player.pos = new Vector(50, 24);
  }
};
